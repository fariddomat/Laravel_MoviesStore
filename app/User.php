...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'gender', 'birth_date',  'married', 'children_number',  'hoppies'
    ];
    ...
    {
        return $this->belongsToMany('App\Movie', 'orders', 'user_id', 'movies_id')->withPivot('name','created_at');
    }
