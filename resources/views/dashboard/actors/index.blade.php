...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Actors </h1>
...
<div class="tile mb-4">
            ...
            <form action="">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        @if (auth()->user()->hasPermission('create_actors'))

                        <a href="{{ route('dashboard.actors.create') }}" class="btn btn-outline-primary"><i
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (auth()->user()->hasPermission('update_actors'))

                            <a href="{{route('dashboard.actors.edit',$actor->id)}}"
                            ...
                            <form action="{{route('dashboard.actors.destroy',$actor->id)}}" method="POST"
            ...
            <div class="text-center m-auto">{{$actors->appends(request()->query())->links()}}</div>
            @else
