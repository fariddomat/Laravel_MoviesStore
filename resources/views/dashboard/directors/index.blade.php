...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Directors </h1>
...
<div class="tile mb-4">
            ...
            <form action="">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        @if (auth()->user()->hasPermission('create_directors'))

                        <a href="{{ route('dashboard.directors.create') }}" class="btn btn-outline-primary"><i
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if (auth()->user()->hasPermission('update_directors'))

                            <a href="{{route('dashboard.directors.edit',$director->id)}}"
                            ...
                            @endif
                            @if (auth()->user()->hasPermission('delete_directors'))

                            <form action="{{route('dashboard.directors.destroy',$director->id)}}" method="POST"
            ...
            <div class="text-center m-auto">{{$directors->appends(request()->query())->links()}}</div>
            @else
