<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container">
        ...
        <a class="navbar-brand glow" href="{{ route('welcome') }}">
            {{setting('site_name') ? setting('site_name') : 'Movie'}}
            <span class="text-primary font-weight-bold">Flix</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form action="" class="col-12 col-md-6 p-0 mt-1">
                <div class="input-group">
                    <input type="search" class="form-control bg-transparent border-0" placeholder="Search for your favorite ">
                    <select id="selector" name="selector" class=" bg-transparent border-0 custom-select" style="color: white;max-width: 120px">
