    ...
    <section class="listing" style="height: 100vh; padding: 8% 0;">
        ...
        <div class="container text-white">
            ...
            <div class="row {{ request()->favorite ? 'favorite' : '' }}">
                ...
                @else
                <img src="{{asset('images/poster.jpg')}}" style="" class="img-fluid" alt="">
                @endif
                            <div class="movie__details text-white">
                                ...
                                <div class="movie___views">
                                    <p>Downloaded: {{$movie->user->count() ? $movie->user->count() : 0}}</p>
                                </div>

                                <div class="d-flex movie__cta">
                                    <a href="{{ route('movies.show', $movie->id) }}" class="btn btn-primary text-capitalize flex-fill mr-2"><i class="fas fa-play"></i> Movie Details</a>
                                    @auth
